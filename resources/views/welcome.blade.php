...
<body>
    ...
    <div class="container hero-section">
        <h1 class="fw-bold mb-3">Inventaris Management of SMK Wikrama</h1> <p class="text-muted fs-5 mb-5">Management of incoming and outgoing items at SMK Wikrama Bogor</p> </div>
